<%@ Page Title="" Language="VB" MasterPageFile="~/POCS2.master" EnableViewState="false" AutoEventWireup="false" CodeFile="CritCareDrugsShort.aspx.vb" Inherits="CritCareDrugsShort" %>
         ...
         <Scripts>
            <asp:ScriptReference Path="js/plugins/DataTablesJS/jquery.dataTables.min.js" />
                ...
                <div class="mail-box-header"><%--  2 CONTENTS PAGE LABEL/HEADING--%>
                     <h1><asp:Label ID="lblTitle" runat="server" Text="Critical Care Drugs"></asp:Label></h1>
<%--                    <a onclick="openPopup('AppFeedback.aspx?f=CritCareDrugsShort.aspx','Feedback',900,400)"><small>Provide feedback</small></a>--%>
<%--                    <a onclick="openPopup('AppFeedback.aspx?f=<%= GetPageName() %>','Feedback',900,400)"><small>Provide feedback</small></a>--%>
<%--                    <button class="btn btn-white btn-xs"  onclick="openPopup('AppFeedback.aspx?f=<%= GetPageName() %>','Feedback',900,500)"><i class="fa fa-share"></i> Provide feedback</button>--%>
                    ...
                    <asp:LinkButton ID="lbtnFeedback" runat="server" class="btn btn-white btn-xs" Visible="false">LinkButton</asp:LinkButton>
