<%@ Page Title="" Language="VB" MasterPageFile="~/POCS2.master" AutoEventWireup="false" CodeFile="AppGetInfoList.aspx.vb" Inherits="AppGetInfoList" %>
         ...
         <Scripts>
            <asp:ScriptReference Path="js/plugins/DataTablesJS/jquery.dataTables.min.js" />
                ...
                <div class="mail-box-header"><%--  2 CONTENTS PAGE LABEL/HEADING--%>
                     <h2><asp:Label ID="lblGridTitle" runat="server" Text="Needed Information"></asp:Label></h2>
                     <asp:Label ID="lblErr" runat="server" Text=""></asp:Label>
                 </div><%-- / 2 CONTENTS PAGE LABEL/HEADING--%>

                <div class="mail-box"><%--  ******  3 -CONTENTS OF PAGE INSIDE THIS DIV ****** --%>
                            <div id="GetInfoDiv" runat="server">
